(function () {
  ...
  describe('Admin Quotes List Controller Tests', function () {
    // Initialize global variables
    var QuotesAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _QuotesService_) {
      ...
      $httpBackend.whenGET('/modules/quotes/client/views/list-quotes.client.view.html').respond(200, '');
      ...
      QuotesAdminListController = $controller('QuotesAdminListController as vm', {
        $scope: $scope
      });
