(function() {
  ...
  angular
    ...
    .constant('PRICING', {
      DRIVEWAY_REGULAR: 625,
      DRIVEWAY_LARGE: 925,
      DRIVEWAY_PARKING: 1295,
      DRIVEWAY_REGULAR_SALT_REGULAR: 226,
      DRIVEWAY_LARGE_SALT_REGULAR: 508,
      DRIVEWAY_PARKING_SALT_REGULAR: 800,
      DRIVEWAY_REGULAR_SALT_ECO: 452,
      DRIVEWAY_LARGE_SALT_ECO: 847.5,
      DRIVEWAY_PARKING_SALT_ECO: 1100,
      DRIVEWAY_SALT_NONE: 0,
      WALKWAY_YES: 210,
      WALKWAY_NO: 0,
      WALKWAY_SALT_REGULAR: 169.5,
      WALKWAY_SALT_ECO: 282.5,
      WALKWAY_SALT_NO: 0,
      SIDEWALK_YES: 150,
      SIDEWALK_NO: 0,
      SIDEWALK_SIZE_CORNER: 100,
      SIDEWALK_SIZE_REGULAR: 0,
      SIDEWALK_SALT_REGULAR: 169.5,
      SIDEWALK_SALT_ECO: 282.5,
      SIDEWALK_SALT_NO: 0,
      CLIENT_SENIOR: 0.95,
      SEASON_HALF: 0.5
    })
